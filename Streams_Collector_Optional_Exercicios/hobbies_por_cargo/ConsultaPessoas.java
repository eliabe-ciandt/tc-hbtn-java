...
public class ConsultaPessoas {
    ...
    public static Map<String, TreeSet<String>> obterHobbiesPorCargo(List<Pessoa> pessoaList) {
        Map<String, TreeSet<String>> mapaPessoas = pessoaList.stream().collect(Collectors.groupingBy(Pessoa::getCargo,
    ...
    public static Map<String, Double> obterMediaSalarioPorCargo(List<Pessoa> pessoas) {
        Map<String, Double> mapaPessoas = pessoas.stream().collect(Collectors
                .groupingBy(Pessoa::getCargo, Collectors.averagingDouble(Pessoa::getSalario)));
